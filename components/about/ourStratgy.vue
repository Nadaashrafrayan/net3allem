...
.animated-image {
  ...
  animation: increaseHeight 5s ease-out forwards; /* Animation settings */
  animation-delay: 1s; /* Delay if you want it to start after a second */
}

/* Keyframes for height increase */
